...
io_add_mouse_viewport_event  :: #force_inline proc(self: ^IO, id: ImID)                                                                      { ImGuiIO_AddMouseViewportEvent(self, id); }
io_add_mouse_wheel_event     :: #force_inline proc(self: ^IO, wh_x: f32, wh_y: f32)                                                          { ImGuiIO_AddMouseWheelEvent(self, wh_x, wh_y); }
...
list_clipper_force_display_range_by_indices :: #force_inline proc(self: ^List_Clipper, item_min: i32, item_max: i32)        { ImGuiListClipper_ForceDisplayRangeByIndices(self, item_min, item_max); }
...
color_edit3                            :: #force_inline proc(label: string, col: [^]f32, flags := Color_Edit_Flags(0)) -> bool                                                                                                      { return swr_igColorEdit3(label, col, flags); }
color_edit4                            :: #force_inline proc(label: string, col: [^]f32, flags := Color_Edit_Flags(0)) -> bool                                                                                                      { return swr_igColorEdit4(label, col, flags); }
color_picker3                          :: #force_inline proc(label: string, col: [^]f32, flags := Color_Edit_Flags(0)) -> bool                                                                                                      { return swr_igColorPicker3(label, col, flags); }
color_picker4                          :: #force_inline proc(label: string, col: [^]f32, flags := Color_Edit_Flags(0), ref_col : ^f32 = nil) -> bool                                                                                { return swr_igColorPicker4(label, col, flags, ref_col); }
...
destroy_platform_windows               :: #force_inline proc()                                                                                                                                                                      { igDestroyPlatformWindows(); }
dock_space                             :: #force_inline proc(id: ImID, size := Vec2(Vec2 {0,0}), flags := Dock_Node_Flags(0), window_class : ^Window_Class = nil) -> ImID                                                           { return igDockSpace(id, size, flags, window_class); }
dock_space_over_viewport               :: #force_inline proc(viewport : ^Viewport = nil, flags := Dock_Node_Flags(0), window_class : ^Window_Class = nil) -> ImID                                                                   { return igDockSpaceOverViewport(viewport, flags, window_class); }
...
drag_float2                            :: #force_inline proc(label: string, v: [^]f32, v_speed := f32(1.0), v_min := f32(0.0), v_max := f32(0.0), format := "%.3f", flags := Slider_Flags(0)) -> bool                               { return swr_igDragFloat2(label, v, v_speed, v_min, v_max, format, flags); }
drag_float3                            :: #force_inline proc(label: string, v: [^]f32, v_speed := f32(1.0), v_min := f32(0.0), v_max := f32(0.0), format := "%.3f", flags := Slider_Flags(0)) -> bool                               { return swr_igDragFloat3(label, v, v_speed, v_min, v_max, format, flags); }
drag_float4                            :: #force_inline proc(label: string, v: [^]f32, v_speed := f32(1.0), v_min := f32(0.0), v_max := f32(0.0), format := "%.3f", flags := Slider_Flags(0)) -> bool                               { return swr_igDragFloat4(label, v, v_speed, v_min, v_max, format, flags); }
...
drag_int2                              :: #force_inline proc(label: string, v: [^]i32, v_speed := f32(1.0), v_min := i32(0), v_max := i32(0), format := "%d", flags := Slider_Flags(0)) -> bool                                     { return swr_igDragInt2(label, v, v_speed, v_min, v_max, format, flags); }
drag_int3                              :: #force_inline proc(label: string, v: [^]i32, v_speed := f32(1.0), v_min := i32(0), v_max := i32(0), format := "%d", flags := Slider_Flags(0)) -> bool                                     { return swr_igDragInt3(label, v, v_speed, v_min, v_max, format, flags); }
drag_int4                              :: #force_inline proc(label: string, v: [^]i32, v_speed := f32(1.0), v_min := i32(0), v_max := i32(0), format := "%d", flags := Slider_Flags(0)) -> bool                                     { return swr_igDragInt4(label, v, v_speed, v_min, v_max, format, flags); }
...
find_viewport_by_id                    :: #force_inline proc(id: ImID) -> ^Viewport                                                                                                                                                 { return igFindViewportByID(id); }
find_viewport_by_platform_handle       :: #force_inline proc(platform_handle: rawptr) -> ^Viewport                                                                                                                                  { return igFindViewportByPlatformHandle(platform_handle); }
...
get_background_draw_list_viewport_ptr  :: #force_inline proc(viewport: ^Viewport) -> ^Draw_List                                                                                                                                     { return igGetBackgroundDrawList_ViewportPtr(viewport); }
...
get_foreground_draw_list_viewport_ptr  :: #force_inline proc(viewport: ^Viewport) -> ^Draw_List                                                                                                                                     { return igGetForegroundDrawList_ViewportPtr(viewport); }
...
get_key_index                          :: #force_inline proc(key: Key) -> i32                                                                                                                                                       { return igGetKeyIndex(key); }
...
get_window_dock_id                     :: #force_inline proc() -> ImID                                                                                                                                                              { return igGetWindowDockID(); }
get_window_dpi_scale                   :: #force_inline proc() -> f32                                                                                                                                                               { return igGetWindowDpiScale(); }
...
get_window_viewport                    :: #force_inline proc() -> ^Viewport                                                                                                                                                         { return igGetWindowViewport(); }
...
input_float2                           :: #force_inline proc(label: string, v: [^]f32, format := "%.3f", flags := Input_Text_Flags(0)) -> bool                                                                                      { return swr_igInputFloat2(label, v, format, flags); }
input_float3                           :: #force_inline proc(label: string, v: [^]f32, format := "%.3f", flags := Input_Text_Flags(0)) -> bool                                                                                      { return swr_igInputFloat3(label, v, format, flags); }
input_float4                           :: #force_inline proc(label: string, v: [^]f32, format := "%.3f", flags := Input_Text_Flags(0)) -> bool                                                                                      { return swr_igInputFloat4(label, v, format, flags); }
...
input_int2                             :: #force_inline proc(label: string, v: [^]i32, flags := Input_Text_Flags(0)) -> bool                                                                                                        { return swr_igInputInt2(label, v, flags); }
input_int3                             :: #force_inline proc(label: string, v: [^]i32, flags := Input_Text_Flags(0)) -> bool                                                                                                        { return swr_igInputInt3(label, v, flags); }
input_int4                             :: #force_inline proc(label: string, v: [^]i32, flags := Input_Text_Flags(0)) -> bool                                                                                                        { return swr_igInputInt4(label, v, flags); }
...
is_key_down                            :: #force_inline proc(key: Key) -> bool                                                                                                                                                      { return igIsKeyDown(key); }
is_key_pressed                         :: #force_inline proc(key: Key, repeat := bool(true)) -> bool                                                                                                                                { return igIsKeyPressed(key, repeat); }
is_key_released                        :: #force_inline proc(key: Key) -> bool                                                                                                                                                      { return igIsKeyReleased(key); }
...
is_window_docked                       :: #force_inline proc() -> bool                                                                                                                                                              { return igIsWindowDocked(); }
...
render_platform_windows_default        :: #force_inline proc(platform_render_arg : rawptr = nil, renderer_render_arg : rawptr = nil)                                                                                                { igRenderPlatformWindowsDefault(platform_render_arg, renderer_render_arg); }
...
set_next_window_class                  :: #force_inline proc(window_class: ^Window_Class)                                                                                                                                           { igSetNextWindowClass(window_class); }
...
set_next_window_dock_id                :: #force_inline proc(dock_id: ImID, cond := Cond(0))                                                                                                                                        { igSetNextWindowDockID(dock_id, cond); }
...
set_next_window_viewport               :: #force_inline proc(viewport_id: ImID)                                                                                                                                                     { igSetNextWindowViewport(viewport_id); }
...
show_stack_tool_window                 :: #force_inline proc(p_open : ^bool = nil)                                                                                                                                                  { igShowStackToolWindow(p_open); }
...
slider_float2                          :: #force_inline proc(label: string, v: [^]f32, v_min: f32, v_max: f32, format := "%.3f", flags := Slider_Flags(0)) -> bool                                                                  { return swr_igSliderFloat2(label, v, v_min, v_max, format, flags); }
slider_float3                          :: #force_inline proc(label: string, v: [^]f32, v_min: f32, v_max: f32, format := "%.3f", flags := Slider_Flags(0)) -> bool                                                                  { return swr_igSliderFloat3(label, v, v_min, v_max, format, flags); }
slider_float4                          :: #force_inline proc(label: string, v: [^]f32, v_min: f32, v_max: f32, format := "%.3f", flags := Slider_Flags(0)) -> bool                                                                  { return swr_igSliderFloat4(label, v, v_min, v_max, format, flags); }
...
slider_int2                            :: #force_inline proc(label: string, v: [^]i32, v_min: i32, v_max: i32, format := "%d", flags := Slider_Flags(0)) -> bool                                                                    { return swr_igSliderInt2(label, v, v_min, v_max, format, flags); }
slider_int3                            :: #force_inline proc(label: string, v: [^]i32, v_min: i32, v_max: i32, format := "%d", flags := Slider_Flags(0)) -> bool                                                                    { return swr_igSliderInt3(label, v, v_min, v_max, format, flags); }
slider_int4                            :: #force_inline proc(label: string, v: [^]i32, v_min: i32, v_max: i32, format := "%d", flags := Slider_Flags(0)) -> bool                                                                    { return swr_igSliderInt4(label, v, v_min, v_max, format, flags); }
...
update_platform_windows                :: #force_inline proc()                                                                                                                                                                      { igUpdatePlatformWindows(); }
