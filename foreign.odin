...
foreign cimgui {
	...
	ImGuiIO_AddMouseViewportEvent  :: proc(self: ^IO, id: ImID) ---;
	ImGuiIO_AddMouseWheelEvent     :: proc(self: ^IO, wh_x: f32, wh_y: f32) ---;
	...
	igDockSpace                         :: proc(id: ImID, size: Vec2, flags: Dock_Node_Flags, window_class: ^Window_Class) -> ImID ---;
	igDockSpaceOverViewport             :: proc(viewport: ^Viewport, flags: Dock_Node_Flags, window_class: ^Window_Class) -> ImID ---;
	...
	igEndTable                          :: proc() ---;
	igEndTooltip                        :: proc() ---;
	igFindViewportByID                  :: proc(id: ImID) -> ^Viewport ---;
	igFindViewportByPlatformHandle      :: proc(platform_handle: rawptr) -> ^Viewport ---;
	...
	igGetKeyIndex                       :: proc(key: Key) -> i32 ---;
	...
	igGetWindowViewport                 :: proc() -> ^Viewport ---;
	...
	igIsKeyDown                         :: proc(key: Key) -> bool ---;
	igIsKeyPressed                      :: proc(key: Key, repeat: bool) -> bool ---;
	igIsKeyReleased                     :: proc(key: Key) -> bool ---;
	...
	igSetNextWindowClass                :: proc(window_class: ^Window_Class) ---;
	igSetNextWindowCollapsed            :: proc(collapsed: bool, cond: Cond) ---;
	igSetNextWindowContentSize          :: proc(size: Vec2) ---;
	igSetNextWindowDockID               :: proc(dock_id: ImID, cond: Cond) ---;
	...
	igSetNextWindowViewport             :: proc(viewport_id: ImID) ---;
